...
def image(category,link,image_title):
    #print ip_port
    loop = True
    while loop:
        ...
        try:
            ...
            output = open(category+"/"+image_title+'.jpg','ab+')
...
if __name__=="__main__":
     category = "try"
     link = "http://img.hindilinks4u.net/2013/12/R...-Rajkumar-20131.jpg"
     image_title = "R4...-Rajkumar-20131"
     image(category,link,image_title)
